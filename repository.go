...
import (
	pb "github.com/ryanyogan/shippy/vessel-service/proto/vessel"
	"gopkg.in/mgo.v2"
...
// Repository defines actions you may use to speak to the data-store.
...
// VesselRepository - Data Store for a `Vessel`
type VesselRepository struct {
	session *mgo.Session
}

// FindAvailable - checks a spec agains a map of vessels,
...
// Close closes the current MongoDB session
